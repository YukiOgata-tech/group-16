...
# coding: UTF-8
"""
ラインフォロワー実機用プログラム（タイトコース向けチューニング）

mbd_phs5 の固定行列マッピングをベースに、
急カーブでの安定性を優先した設定で走行します。

実行方法:
    $ python3 real_line_follower_alt.py
...
def main():
    """メイン関数"""
    print("=" * 50)
    print("ラインフォロワー実機用プログラム (タイトコース向け)")
    print("=" * 50)
    print("初期化中...")
